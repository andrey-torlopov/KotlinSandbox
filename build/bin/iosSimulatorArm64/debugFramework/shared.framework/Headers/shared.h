...
- (int32_t)calculateA:(int32_t)a b:(int32_t)b __attribute__((swift_name("calculate(a:b:)")));
- (NSString *)createMessageName:(NSString *)name __attribute__((swift_name("createMessage(name:)")));
